...
```
## [1] "/Users/ellyn/Desktop/BIS15W2022_eparis/lab3"
```
...
## $ temp      <dbl> 36.25, 35.40, 35.30, 35.15, 35.35, 33.35, 30.70, 29.65, 29.20
...
```r
fish <- readr::read_csv("Gaeta_etal_CLC_data.csv.webloc")
```
...
```
## spec_tbl_df [7 × 1] (S3: spec_tbl_df/tbl_df/tbl/data.frame)
##  $ <?xml version="1.0" encoding="UTF-8"?>: chr [1:7] "<!DOCTYPE plist PUBLIC \"-//Apple//DTD PLIST 1.0//EN\" \"http://www.apple.com/DTDs/PropertyList-1.0.dtd\">" "<plist version=\"1.0\">" "<dict>" "<key>URL</key>" ...
##  - attr(*, "spec")=
##   .. cols(
##   ..   `<?xml version="1.0" encoding="UTF-8"?>` = col_character()
##   .. )
##  - attr(*, "problems")=<externalptr>
```
...
## Rows: 7
## Columns: 1
## $ `<?xml version="1.0" encoding="UTF-8"?>` <chr> "<!DOCTYPE plist PUBLIC \"-//…
```
...
##   `<?xml version="1.0" encoding="UTF-8"?>`                                      
##   <chr>                                                                         
## 1 "<!DOCTYPE plist PUBLIC \"-//Apple//DTD PLIST 1.0//EN\" \"http://www.apple.co…
## 2 "<plist version=\"1.0\">"                                                     
## 3 "<dict>"                                                                      
## 4 "<key>URL</key>"                                                              
## 5 "<string>https://github.com/jmledford3115/datascibiol/blob/master/lab3/data/G…
## 6 "</dict>"                                                                     
## 7 "</plist>"
```
...
```
## Warning: Unknown or uninitialised column: `lakeid`.
```
