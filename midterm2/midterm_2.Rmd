...
```{r}
gapminder_join %>% 
   filter(country == c("Germany", "France", "United States", "Afghanistan", "Ethiopia", "Malaysia")) %>% 
  ggplot(aes(x=mean_life_exp))+
  geom_density()+
  facet_grid(mean_life_exp~gdp_percap, scales = "free_y")
```
