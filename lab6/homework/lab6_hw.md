...
```r
fisheries <- readr::read_csv(file = "/Users/ellyn/Desktop/BIS15W2022_eparis/lab6/data/FAO_1950to2012_111914.csv")
```
...
```r
fisheries_tidy %>%
  summarize(across(c(asfis_species_number),n_distinct))
```
...
```r
which.max(fisheries_tidy$catch)
```
...
##   <fct>   <chr>           <fct>             <chr>               <fct>           
## 1 Peru    Anchoveta(=Per… 35                Herrings, sardines… 1210600208      
...
##    <fct>   <chr>             <fct>             <chr>            <fct>           
##  1 Albania Marine fishes nei 39                Marine fishes n… 199XXXXXXX010   
##  2 Albania Marine fishes nei 39                Marine fishes n… 199XXXXXXX010   
##  3 Albania Marine fishes nei 39                Marine fishes n… 199XXXXXXX010   
##  4 Albania Marine fishes nei 39                Marine fishes n… 199XXXXXXX010   
##  5 Albania Marine fishes nei 39                Marine fishes n… 199XXXXXXX010   
##  6 Albania Marine fishes nei 39                Marine fishes n… 199XXXXXXX010   
##  7 Albania Marine fishes nei 39                Marine fishes n… 199XXXXXXX010   
##  8 Albania Marine fishes nei 39                Marine fishes n… 199XXXXXXX010   
##  9 Albania Marine fishes nei 39                Marine fishes n… 199XXXXXXX010   
## 10 Albania Marine fishes nei 39                Marine fishes n… 199XXXXXXX010   
## # … with 16,194 more rows, and 5 more variables: asfis_species_name <chr>,
## #   fao_major_fishing_area <fct>, measure <chr>, year <dbl>, catch <dbl>
```


```r
highest_catch <- fisheries_tidy %>%
...
```r
highest_catch_2.0 <-subset(highest_catch, asfis_species_name!="Osteichthyes")
```



```r
which.max(highest_catch_2.0$catch)
```
...
```r
highest_catch_2.0[6179,]
```

```
## # A tibble: 1 × 3
##   asfis_species_name  catch  year
##   <chr>               <dbl> <dbl>
## 1 Trichiurus lepturus  8221  2011
```
10. Use the data to do at least one analysis of your choice.

```r
fisheries_tidy %>% count(country, fao_major_fishing_area)
```

```
## # A tibble: 629 × 3
##    country             fao_major_fishing_area     n
##    <fct>               <fct>                  <int>
##  1 Albania             37                       934
##  2 Algeria             37                      1561
##  3 American Samoa      77                       556
##  4 Angola              34                        86
##  5 Angola              47                      2033
##  6 Anguilla            31                       129
##  7 Antigua and Barbuda 31                       356
##  8 Argentina           34                        13
##  9 Argentina           41                      3326
## 10 Argentina           48                        32
## # … with 619 more rows
