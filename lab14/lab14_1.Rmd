...
##Some of the distributions in the data would have been missed if only using a boxplot. FOr example, thanks ot the violin map you can see that for birds there is a non-normal distribution when it comes to log 10 mass.
...
## Practice
  ...
  ##Drug d lowers the heart rate while drug c raises it. 
