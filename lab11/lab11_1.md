...
homerange %>% 
  ...
  geom_histogram(alpha = 0.4, color = "brown", fill = "salmon1", bins=40)+
...
homerange %>% 
  ...
  geom_histogram(alpha = 0.4, color = "brown", fill = "salmon1")+
  labs(title = "Distribution Homerange")
```
...
homerange %>% 
  ggplot(aes(x = log10.hra)) +
  geom_density(fill="palevioletred3", alpha  =0.4, color = "black")+
...
homerange %>% 
   ggplot(aes(x=log10.hra)) +
  geom_histogram(aes(y = ..density..), fill = "mediumorchid", alpha = 0.4, color = "black")+
  geom_density(color = "khaki4")+
  labs(title = "Distribution of Homerange")
```
...
## $ prey.size.reference        <chr> NA, NA, NA, NA, NA, NA, "Brose U, et al. 20…
## $ mass_category              <chr> "large", "medium", "small", "small", "small…
## $ range_category             <chr> "medium", "very_small", "very_small", "very…
```
