...
## There are 0 Nas in amniota and 170,566 in amphibio. The number in amniota does not make sense and probably indicates that NAs are indicated by the number "-999" instead of an NA in the data set, as we see this number appearing frequently when using the glimpse() function. 
`amniota`  
