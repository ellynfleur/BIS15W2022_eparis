...
## there are NAs, but they are represetned by the value "-999.0"
...
```r
hist(amniota$maximum_longevity_y)
```

![](lab7_1_files/figure-html/unnamed-chunk-18-1.png)<!-- -->
...
## I see some -999 values that I assume are NAs.
