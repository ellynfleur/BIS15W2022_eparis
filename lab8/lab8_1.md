...
##tsome column names are variables (income)
...
relig_income %>% 
  pivot_longer(-religion,
               names_to = "income",
               values_to = "amount_ppl"
               )
```

```
## # A tibble: 180 × 3
##    religion income             amount_ppl
##    <chr>    <chr>                   <dbl>
##  1 Agnostic <$10k                      27
...
## the days (which are variables) are put as column names in this data frame.
...
```
## # A tibble: 90 × 5
##    genotype water_sched_prog greenhouse day   water_content
##    <chr>    <chr>            <chr>      <chr>         <dbl>
